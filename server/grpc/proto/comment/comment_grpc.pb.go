...
type CommentServiceClient interface {
	...
	Comments(ctx context.Context, in *CommentRequest, opts ...grpc.CallOption) (*CommentResponse, error)
}
...
func (c *commentServiceClient) Comments(ctx context.Context, in *CommentRequest, opts ...grpc.CallOption) (*CommentResponse, error) {
	out := new(CommentResponse)
	err := c.cc.Invoke(ctx, "/comment.CommentService/Comments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommentServiceServer interface {
	...
	Comments(context.Context, *CommentRequest) (*CommentResponse, error)
...
func (UnimplementedCommentServiceServer) Comments(context.Context, *CommentRequest) (*CommentResponse, error) {
...
func _CommentService_Comments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comment.CommentService/Comments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).Comments(ctx, req.(*CommentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "server/grpc/proto/comment/comment.proto",
}
